...
get pets (meow/bhaw) for you on a single key press (any key), because who doesn't like to look at cat/dog pictures

> meow because cat says meow
> bhaw because dog says bhaw (at least in my native tongue, kept since it matched with meow)
...
meow page (cat page)
![moew page](./screenshots/cat_page.png)

bhaw page (dog page)
![bhaw page](./screenshots/dog_page.png)


## Credits
- made by me
- API used: [https://thecatapi.com/](https://thecatapi.com/) (this also had dog pictures)
- icons on home page: [https://phosphoricons.com/](https://phosphoricons.com/)
- background images from: pinterest
- sound effects from: [https://pixabay.com/sound-effects/search/](https://pixabay.com/sound-effects/search/)
